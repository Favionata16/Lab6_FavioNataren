...
public class Login extends javax.swing.JFrame {
    ...
    private void LoginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LoginButtonMouseClicked
        ...
        if(nombre.equals("p") && password.equals("p")){
            AdminFrame.setModal(true);
            AdminFrame.pack();
            AdminFrame.setLocationRelativeTo(this);
            AdminFrame.setVisible(true);
        }else{
            if(a.Buscar(nombre, password) != null){
                pinguino = a.Buscar(nombre, password);
                ...
                if(a.Buscar(nombre, password) == null){
                    Pinguino pinguino = new Pinguino(nombre, password);
                    a.pinguinos.add(pinguino);

                    this.pinguino = a.Buscar(nombre, password);
    ...
    private void VenderCasaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VenderCasaMouseClicked
        ...
        if(pinguino.getCasa() != null){
            ...
            NombreCasa.setText("No posee una casa!");
            ActualizarDinero();
